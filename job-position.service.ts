...
export class JobService{
    ...
    constructor(private http : HttpClient){ 
        ...
        this.addJobURL = 'http://localhost:5452/job/addJobPosition';
        this.getJobURL = 'http://localhost:5452/job/getAllJob';
        this.updateJobURL = 'http://localhost:5452/job/updateJob';
        this.deleteJobURL = 'http://localhost:5452/job/deleteJobById';
